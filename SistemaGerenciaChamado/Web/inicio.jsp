...
<%
	...
	if (usuario == null || idU == 0) {
		%>
		<script>alert('Usuario e/ou senha incorretos ...');
...
<body>
	<h2>
		...
		<%=usuario%></h2>
	<br>
	<a href="index.jsp" onclick="location.href='Logout'">Logoff</a>
	<form action="" method="post" name="inicio">
	<p>
		<input type="button" name="" Value="Novo Chamado"
			onclick="location.href='novochamado.jsp'">
		<span>
		<%
		...
		<table border="1" width="80%">
			...
			<tr>
				<td colspan="2"><a href="tratarchamado.jsp?idchamado=<%=cmd.getIdChamado()%>&usuario=<%=cmd.func.getNome2()%>&email=<%=cmd.func.getEmail()%>&telefone=
